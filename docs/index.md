...
---
# Journal
My personal journal in technology ...and other things.  I am using [[journal/docs/Tools/Obsidian]] to generate and maintain this journal - using [[GitHub-Quartz-Obsidian]] to publish it.

## Recent Project Focuses
- [[Lab Setup/Cloud Init]] - A *needed* thing for Proxmox VMs. Finished testing this today, and decised that I need to go a step further - I need to automatically set the proxy and the netplan.  Perhaps that is a job for [[Ansible]]!  ...*sigh* ... adding this as a new focus tomorrow even though I have been poking it along for a while now ;)
- [[The Stack]] - Defining the tech stack I use/support most. Today I added testing for a [[email]] server.
