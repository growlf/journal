...
The [[Tools/Proxmox]] command line is a powerful thing. Everything done in the GUI, can be done in the command line - and thus also through automation with something like [[Ansible]].
