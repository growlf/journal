...
management_url: https://nexus.yeticraft.net:8006/
---
Some very helpful stuff can be found in the [ProxMox Scripts](https://community-scripts.github.io/ProxmoxVE/scripts) -  awesome extras, LXCs and "ready to go" VMs, etc.
