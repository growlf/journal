...
---
# Description
Supplemental scripts and configuration examples for [[Network/Services/CouchDB/index|obsidian-sync]].
## Docker Deployment
...
- [x] add `init.sh` script for basic [[Network/Services/CouchDB/index|obsidian-sync]] configuration ✅ 2025-09-10