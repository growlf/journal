...
3) Next -
	- If you are using Portainer:
		1) create [[Network/Services/CouchDB/CouchDB Deployment Files]] from example (add note for swarm deployment vs standalone)
...
This is a new note created from a template.  
