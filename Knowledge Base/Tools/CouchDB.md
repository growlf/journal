...
#### Dynamic IP
Tools such as [[Knowledge Base/Tools/Tailscale]] can be used to simulate a static IP nicely. 
...
- [[Docker]]
- [[Knowledge Base/Tools/LXC]]
- Virtual Machine
- Kubernetes
- Dedicated system (Raspberry Pi?)
I will be focusing on the Docker and LXC options because [[Knowledge Base/Tools/Proxmox]] and [[Knowledge Base/Tools/Portainer]] both just make this so darned easy. If you have neither [[Knowledge Base/Tools/Proxmox]] nor [[Knowledge Base/Tools/Portainer]] set up, I heartily recommend _both_.  They work very well together.  As I state elsewhere (and frequently) I recommend starting with [[Knowledge Base/Tools/Proxmox]] if you can.
