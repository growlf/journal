...
> I am The NetYeti—Garth Johnson. DevOps professional, Technology Instructor at [BTC](https://www.btc.edu/), and Army Veteran. Dedicated to "raising the water level" of knowledge in our community.
...
Demystifying AI through a **Local-First Hybrid** strategy. See the [[Knowledge Base/LLM/Hybrid Architecture - The PACE Plan|PACE Plan]].

### 🏫 [[Knowledge Base/Community/Mentor-based Internship|Cascade STEAM Service Corp]]
Mentorship-based internship model with [[BMS|Bellingham Makerspace]].

### 🏰 [[Home Lab 101|The Stack]]
The self-hosted environment evolution. Documented in [[Network/The Stack|The Stack]].
