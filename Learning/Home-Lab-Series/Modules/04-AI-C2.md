...
Deploy Ollama using our **[[Internal/Networks/Yeticraft/Services/Ollama/Signal Report|Docker V2 Standard]]**. This ensures it can "see" your GPU hardware. Run `ollama run llama3` to verify the signal.
...
**Status:** Operational
**Related:** [[Internal/Networks/Yeticraft/Services/Ollama/index]], [[Knowledge Base/LLM/OpenClaw]]
